...
public:
   ...
   * and set the property_use_underline() property to <tt>false</tt> as
   * a side effect.
   * 
   ...
   * Gtk::Widget::signal_mnemonic_activate() signal on it. The default handler for
...
/** <tt>true</tt> if the text of the label includes Pango markup.
  ...
  /** <tt>true</tt> if the text of the label indicates a mnemonic with an _
